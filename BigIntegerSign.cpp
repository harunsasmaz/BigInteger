...
BNsign::BNsign(BNsign&& bn) noexcept : value(move(bn.value)) , sign(bn.sign) {}

BNsign::BNsign(BN&& bn, const bool bnsign) noexcept : value(move(bn)) , sign(bnsign) {}
